...
#define POSK_MEMORY_MAGIC_START_NUMBER      0xD0000 /* DO NOT CHANGE THIS UNDER PENALTY OF BEING FORCED TO PROGRAM ON MS BOB 								FOR THE NEXT 7 YEARS.  Seriously.  This number needs to be higher
